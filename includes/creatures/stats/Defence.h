#ifndef MAGICALFOESTFIGHTS_DEFENCE_H
#define MAGICALFOESTFIGHTS_DEFENCE_H
...
namespace MagicalForestFights::Creatures::Stats {
    ...
    class Defence : public CreatureStat<T> {
        using base_t = CreatureStat<T>;
    public:
        Defence(int min, int max) : CreatureStat<T>() {
...
#endif //MAGICALFOESTFIGHTS_DEFENCE_H
