#ifndef MAGICALFOESTFIGHTS_STRENGTH_H
#define MAGICALFOESTFIGHTS_STRENGTH_H
...
namespace MagicalForestFights::Creatures::Stats {
    ...
    class Strength : public CreatureStat<T> {
        using base_t = CreatureStat<T>;
    public:
        Strength(int min, int max) : CreatureStat<T>() {
...
#endif //MAGICALFOESTFIGHTS_STRENGTH_H
